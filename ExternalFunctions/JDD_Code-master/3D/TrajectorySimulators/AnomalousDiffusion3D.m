%Simulation of 3D Anomalous Diffusion
%Rebecca Menssen
%Last edited: 8/30/17-adding final comments and clearing up notation

%This code simulates anomalous diffusion in three dimensions
...
%%%%%%%%%%OUTPUTS%%%%%%%%%%
%x,y,z--array of simulated trajectories for each dimension. 
