...
% Version 2, March, 2015, by Tom O'Haver (toh@umd.edu)
%
% Example: 
% >> load spectrum
% >> load DataTableCu
...
%
% This example loads the mat file "spectrum" which contains a spectrum "Cu"
% (x=wavelength in nm, y=intensity), loads the database "DataTable"
% (containing an array of known peak maximum positions "Positions" and
% matching cell array of names "Names"), finds all the peaks in spectrum
% that have oeak heights greated than 0.01 a smoothwidth of 5, and fitwidth
% of 5, then lists any peak in Cu that matches a known peaks in Positions
% withn an error tolerance of 0.01 nm, and returns a table of identified
% peaks.
%
% Related function: idpeaktable.m
