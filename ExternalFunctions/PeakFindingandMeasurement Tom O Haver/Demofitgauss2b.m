...
Width2=200;  
Baseline=5;
y = Baseline+Height1.*gaussian(t,Position1,Width1) + Height2.*gaussian(t,Position2,Width2) + noise.*randn(size(t));
...
peak1=c(2).*gaussian(t,parameter(1),parameter(2));
peak2=c(3).*gaussian(t,parameter(3),parameter(4));
