% Real-time smoothing  using ProcessSignal function, line 28.  Line 21
...
SmoothWidth=11; % Smooth width (odd integer)
SmoothType=1; % 1=sliding average, 2=triangular, 3=Gaussian, 4=Savitzky-Golay
noise=.05; % standard deviation of normally distributed white noise
...
for n=1:maxx
    ...
    if n==1
        ...
        sy=ProcessSignal(1:n,y,0,TempSmoothWidth,SmoothType,1,0,0,0,0,0,0,0);
