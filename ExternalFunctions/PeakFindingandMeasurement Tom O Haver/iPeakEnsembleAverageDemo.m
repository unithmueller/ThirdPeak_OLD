% A self-contained demonstration of the ensemble averaging function of
% iPeak. In this example, the signal contains a repeated pattern of two
% overlapping Gaussian peaks of width 12, with a 2:1 height ratio. These
% patterns occur a random intervals, and the noise level is about 10% of
% the average peak height. Using iPeak's ensemble average function
% (Shift-E), the patterns can be averaged and the signal-to-noise ratio
...
disp(' ')
disp('Load the ensemble averated signal pattern by typing this: ')
disp('load EnsembleAverage')
disp(' ')
