...
% Requires the gaussian, fitgauss2animatedError, and fminsearch functions
% to be in the Matlab path. Thise version adds a plot of fitting error vs
% iteration nunber. T. C. O'Haver, May 2019
format compact
