classdef LeastSquareEstimatorEllipse < GridEstimator
    properties
        Flag3d
    end
    methods(Static)
        function obj = LeastSquareEstimatorEllipse(trajs, drift, nh, ellips, inEllipseOnly, Flag3d)
            obj = obj@GridEstimator(trajs, ellips, drift, nh, inEllipseOnly);
            obj.Flag3d = Flag3d;
        end
