classdef LeastSqaureEstimatorEllipseFit < GridEstimator
    properties
    end
    methods(Static)
        function obj = LeastSqaureEstimatorEllipseFit(trajs, drift, nh, ellips, inellipsonly, Flag3d)
            obj = obj@GridEstimator(trajs, ellips, drift, nh, inellipsonly, Flag3d);
        end
